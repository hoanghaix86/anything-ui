...
// types
type TSignInFormProps = React.ComponentPropsWithoutRef<'div'>
...
// component
export const SignInForm = ({ className, ...props }: TSignInFormProps) => {
    const navigate = useNavigate()

    const form = useForm({
        defaultValues: {
            email: 'admin@anything.dev',
            password: 'Anything@@@000',
        },
        validators: {
